...
public class RTCStats {
  ...
  @CalledByNative
  static org.webrtc.zzwtec.RTCStats create(long timestampUs, String type, String id, Map members) {
    return new org.webrtc.zzwtec.RTCStats(timestampUs, type, id, members);
  }
}
