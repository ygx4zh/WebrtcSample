...
public class RtcCertificatePem {
   ...
   * expires = 30 days.
   */
  public static org.webrtc.zzwtec.RtcCertificatePem generateCertificate() {
   ...
   * expires = 30 days.
   */
  public static org.webrtc.zzwtec.RtcCertificatePem generateCertificate(PeerConnection.KeyType keyType) {
   ...
   * KeyType = ECDSA.
   */
  public static org.webrtc.zzwtec.RtcCertificatePem generateCertificate(long expires) {
  ...
  private static native org.webrtc.zzwtec.RtcCertificatePem nativeGenerateCertificate(
      PeerConnection.KeyType keyType, long expires);
}
