...
public interface EglBase {
   ...
   */
  public static org.webrtc.zzwtec.EglBase create(@Nullable Context sharedContext, int[] configAttributes) {
    if (sharedContext == null) {
      return org.webrtc.zzwtec.EglBase14Impl.isEGL14Supported() ? createEgl14(configAttributes)
   ...
   */
  public static org.webrtc.zzwtec.EglBase create() {
   ...
   */
  public static org.webrtc.zzwtec.EglBase create(Context sharedContext) {
    return create(sharedContext, CONFIG_PLAIN);
  }

  /** Explicitly create a root EGl 1.0 context with the specified config attributes. */
  public static EglBase10 createEgl10(int[] configAttributes) {
    return new org.webrtc.zzwtec.EglBase10Impl(/* sharedContext= */ null, configAttributes);
  }
  ...
  public static EglBase10 createEgl10(EglBase10.Context sharedContext, int[] configAttributes) {
    return new org.webrtc.zzwtec.EglBase10Impl(
  ...
  public static EglBase10 createEgl10(
    ...
    return new org.webrtc.zzwtec.EglBase10Impl(sharedContext, configAttributes);
  }

  /** Explicitly create a root EGl 1.4 context with the specified config attributes. */
  public static EglBase14 createEgl14(int[] configAttributes) {
    return new org.webrtc.zzwtec.EglBase14Impl(/* sharedContext= */ null, configAttributes);
  }
  ...
  public static EglBase14 createEgl14(EglBase14.Context sharedContext, int[] configAttributes) {
    return new org.webrtc.zzwtec.EglBase14Impl(
        sharedContext == null ? null : sharedContext.getRawContext(), configAttributes);
  }
  ...
  public static EglBase14 createEgl14(
    ...
    return new org.webrtc.zzwtec.EglBase14Impl(sharedContext, configAttributes);
  }
