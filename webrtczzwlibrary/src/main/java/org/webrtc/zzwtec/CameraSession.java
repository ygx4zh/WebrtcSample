...
interface CameraSession {
  ...
  interface CreateSessionCallback {
    void onDone(org.webrtc.zzwtec.CameraSession session);
  ...
  interface Events {
    ...
    void onCameraError(org.webrtc.zzwtec.CameraSession session, String error);
    void onCameraDisconnected(org.webrtc.zzwtec.CameraSession session);
    void onCameraClosed(org.webrtc.zzwtec.CameraSession session);
    void onFrameCaptured(org.webrtc.zzwtec.CameraSession session, VideoFrame frame);
  }
