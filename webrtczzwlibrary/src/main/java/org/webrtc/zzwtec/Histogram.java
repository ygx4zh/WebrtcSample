...
class Histogram {
  ...
  static public org.webrtc.zzwtec.Histogram createCounts(String name, int min, int max, int bucketCount) {
    return new org.webrtc.zzwtec.Histogram(nativeCreateCounts(name, min, max, bucketCount));
  }

  static public org.webrtc.zzwtec.Histogram createEnumeration(String name, int max) {
    return new org.webrtc.zzwtec.Histogram(nativeCreateEnumeration(name, max));
  }
