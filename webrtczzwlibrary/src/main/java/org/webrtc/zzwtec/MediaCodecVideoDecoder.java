...
public class MediaCodecVideoDecoder {
  ...
  static class HwDecoderFactory implements VideoDecoderFactory {
    ...
    public VideoDecoder createDecoder(VideoCodecInfo codec) {
      ...
      return new org.webrtc.zzwtec.WrappedNativeVideoDecoder() {
        @Override
  ...
  @Nullable private static org.webrtc.zzwtec.MediaCodecVideoDecoder runningInstance;
  ...
  public static void setErrorCallback(MediaCodecVideoDecoderErrorCallback errorCallback) {
    ...
    org.webrtc.zzwtec.MediaCodecVideoDecoder.errorCallback = errorCallback;
  }
