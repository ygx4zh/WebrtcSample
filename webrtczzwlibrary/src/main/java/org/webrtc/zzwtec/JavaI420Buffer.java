...
import org.webrtc.zzwtec.VideoFrame.I420Buffer;
...
public class JavaI420Buffer implements I420Buffer {
  ...
  public static org.webrtc.zzwtec.JavaI420Buffer wrap(int width, int height, ByteBuffer dataY, int strideY,
    ...
    return new org.webrtc.zzwtec.JavaI420Buffer(
        width, height, dataY, strideY, dataU, strideU, dataV, strideV, releaseCallback);
  }

  /** Allocates an empty I420Buffer suitable for an image of the given dimensions. */
  public static org.webrtc.zzwtec.JavaI420Buffer allocate(int width, int height) {
    ...
    return new org.webrtc.zzwtec.JavaI420Buffer(width, height, dataY, width, dataU, strideUV, dataV, strideUV,
  ...
  public static VideoFrame.Buffer cropAndScaleI420(final I420Buffer buffer, int cropX, int cropY,
    ...
    if (cropWidth == scaleWidth && cropHeight == scaleHeight) {
      ...
      buffer.retain();
      return wrap(scaleWidth, scaleHeight, dataY.slice(), buffer.getStrideY(),
          dataU.slice(), buffer.getStrideU(), dataV.slice(), buffer.getStrideV(), buffer::release);
    }

    org.webrtc.zzwtec.JavaI420Buffer newBuffer = allocate(scaleWidth, scaleHeight);
