...
class VolumeLogger {
  ...
  public void start() {
    Logging.d(TAG, "start" + org.webrtc.zzwtec.audio.WebRtcAudioUtils.getThreadInfo());
    if (timer != null) {
      return;
    }
    Logging.d(TAG, "audio mode is: " + org.webrtc.zzwtec.audio.WebRtcAudioUtils.modeToString(audioManager.getMode()));
  ...
  public void stop() {
    Logging.d(TAG, "stop" + org.webrtc.zzwtec.audio.WebRtcAudioUtils.getThreadInfo());
    if (timer != null) {
      timer.cancel();
      timer = null;
    }
