...
package org.webrtc.zzwtec.audio;

import android.content.Context;
import android.media.AudioManager;

import org.webrtc.zzwtec.JniCommon;
...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  public static class Builder {
    ...
    private int audioSource = org.webrtc.zzwtec.audio.WebRtcAudioRecord.DEFAULT_AUDIO_SOURCE;
    private int audioFormat = org.webrtc.zzwtec.audio.WebRtcAudioRecord.DEFAULT_AUDIO_FORMAT;
    ...
    private Builder(Context context) {
      ...
      this.inputSampleRate = org.webrtc.zzwtec.audio.WebRtcAudioManager.getSampleRate(audioManager);
      this.outputSampleRate = org.webrtc.zzwtec.audio.WebRtcAudioManager.getSampleRate(audioManager);
    }
    ...
    public AudioDeviceModule createAudioDeviceModule() {
      ...
      final org.webrtc.zzwtec.audio.WebRtcAudioRecord audioInput = new org.webrtc.zzwtec.audio.WebRtcAudioRecord(context, audioManager, audioSource,
          audioFormat, audioRecordErrorCallback, samplesReadyCallback,
          useHardwareAcousticEchoCanceler, useHardwareNoiseSuppressor);
      final org.webrtc.zzwtec.audio.WebRtcAudioTrack audioOutput =
          new org.webrtc.zzwtec.audio.WebRtcAudioTrack(context, audioManager, audioTrackErrorCallback);
      return new org.webrtc.zzwtec.audio.JavaAudioDeviceModule(context, audioManager, audioInput, audioOutput,
  ...
  public static boolean isBuiltInAcousticEchoCancelerSupported() {
    return org.webrtc.zzwtec.audio.WebRtcAudioEffects.isAcousticEchoCancelerSupported();
  }
  ...
  public static boolean isBuiltInNoiseSuppressorSupported() {
    return org.webrtc.zzwtec.audio.WebRtcAudioEffects.isNoiseSuppressorSupported();
  }

  private final Context context;
  private final AudioManager audioManager;
  private final org.webrtc.zzwtec.audio.WebRtcAudioRecord audioInput;
  private final org.webrtc.zzwtec.audio.WebRtcAudioTrack audioOutput;
  ...
  private JavaAudioDeviceModule(Context context, AudioManager audioManager,
                                org.webrtc.zzwtec.audio.WebRtcAudioRecord audioInput, org.webrtc.zzwtec.audio.WebRtcAudioTrack audioOutput, int inputSampleRate,
  ...
  private static native long nativeCreateAudioDeviceModule(Context context,
                                                           AudioManager audioManager, org.webrtc.zzwtec.audio.WebRtcAudioRecord audioInput, org.webrtc.zzwtec.audio.WebRtcAudioTrack audioOutput,
