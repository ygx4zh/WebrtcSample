...
class AndroidVideoDecoder implements VideoDecoder, VideoSink {
  ...
  private final org.webrtc.zzwtec.MediaCodecWrapperFactory mediaCodecWrapperFactory;
  private final String codecName;
  private final org.webrtc.zzwtec.VideoCodecType codecType;
  ...
  // Valid and immutable while the decoder is running.
  @Nullable private org.webrtc.zzwtec.MediaCodecWrapper codec;

  AndroidVideoDecoder(org.webrtc.zzwtec.MediaCodecWrapperFactory mediaCodecWrapperFactory, String codecName,
                      org.webrtc.zzwtec.VideoCodecType codecType, int colorFormat, @Nullable EglBase.Context sharedContext) {
  ...
  private Thread createOutputThread() {
    return new Thread("AndroidVideoDecoder.outputThread") {
      @Override
      public void run() {
        outputThreadChecker = new ThreadUtils.ThreadChecker();
        while (running) {
          deliverDecodedFrame();
        }
  ...
  private boolean isSupportedColorFormat(int colorFormat) {
    for (int supported : org.webrtc.zzwtec.MediaCodecUtils.DECODER_COLOR_FORMATS) {
