...
class Camera2Session implements CameraSession {
  ...
  private class CameraStateCallback extends CameraDevice.StateCallback {
    ...
    public void onDisconnected(CameraDevice camera) {
      ...
      if (startFailure) {
        ...
        events.onCameraDisconnected(org.webrtc.zzwtec.Camera2Session.this);
      }
    }
    ...
    public void onClosed(CameraDevice camera) {
      ...
      events.onCameraClosed(org.webrtc.zzwtec.Camera2Session.this);
    }
  }
  ...
  private class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
    ...
    public void onConfigured(CameraCaptureSession session) {
      ...
      surfaceTextureHelper.startListening((VideoFrame frame) -> {
        ...
        events.onFrameCaptured(org.webrtc.zzwtec.Camera2Session.this, modifiedFrame);
        modifiedFrame.release();
      });
      Logging.d(TAG, "Camera device successfully started.");
      callback.onDone(org.webrtc.zzwtec.Camera2Session.this);
    }
  ...
  public static void create(CreateSessionCallback callback, Events events,
                            ...
                            int framerate) {
    new org.webrtc.zzwtec.Camera2Session(callback, events, applicationContext, cameraManager, surfaceTextureHelper,
