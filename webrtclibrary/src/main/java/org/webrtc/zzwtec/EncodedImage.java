...
public class EncodedImage {
  ...
  public static class Builder {
    ...
    public org.webrtc.zzwtec.EncodedImage createEncodedImage() {
      return new org.webrtc.zzwtec.EncodedImage(buffer, encodedWidth, encodedHeight, captureTimeNs, frameType,
