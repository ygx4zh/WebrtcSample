...
public class GlRectDrawer extends org.webrtc.zzwtec.GlGenericDrawer {
  private static final String FRAGMENT_SHADER = "void main() {\n"
      + "  gl_FragColor = sample(tc);\n"
      + "}\n";

  private static class ShaderCallbacks implements org.webrtc.zzwtec.GlGenericDrawer.ShaderCallbacks {
    @Override
