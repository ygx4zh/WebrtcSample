...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
  ...
  private final org.webrtc.zzwtec.RefCountDelegate refCountDelegate;
  ...
  public TextureBufferImpl(int width, int height, Type type, int id, Matrix transformMatrix,
    ...
    this.refCountDelegate = new org.webrtc.zzwtec.RefCountDelegate(releaseCallback);
  }
   ...
   */
  public org.webrtc.zzwtec.TextureBufferImpl applyTransformMatrix(
  ...
  private org.webrtc.zzwtec.TextureBufferImpl applyTransformMatrix(Matrix transformMatrix, int unscaledWidth,
                                                                   int unscaledHeight, int scaledWidth, int scaledHeight) {
    final Matrix newMatrix = new Matrix(this.transformMatrix);
    newMatrix.preConcat(transformMatrix);
    retain();
    return new org.webrtc.zzwtec.TextureBufferImpl(unscaledWidth, unscaledHeight, scaledWidth, scaledHeight, type, id,
