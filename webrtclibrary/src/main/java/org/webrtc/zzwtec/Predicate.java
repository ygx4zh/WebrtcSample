...
public interface Predicate<T> {
   ...
   */
  default org.webrtc.zzwtec.Predicate<T> or(org.webrtc.zzwtec.Predicate<? super T> other) {
    return new org.webrtc.zzwtec.Predicate<T>() {
      @Override
      public boolean test(T arg) {
        return org.webrtc.zzwtec.Predicate.this.test(arg) || other.test(arg);
      }
    };
  }
   ...
   *     and the other predicate
   */
  default org.webrtc.zzwtec.Predicate<T> and(org.webrtc.zzwtec.Predicate<? super T> other) {
    return new org.webrtc.zzwtec.Predicate<T>() {
      @Override
      public boolean test(T arg) {
        return org.webrtc.zzwtec.Predicate.this.test(arg) && other.test(arg);
   ...
   */
  default org.webrtc.zzwtec.Predicate<T> negate() {
    return new org.webrtc.zzwtec.Predicate<T>() {
      @Override
      public boolean test(T arg) {
        return !org.webrtc.zzwtec.Predicate.this.test(arg);
      }
    };
  }
}