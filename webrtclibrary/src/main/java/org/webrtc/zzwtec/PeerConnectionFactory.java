...
import org.webrtc.zzwtec.Logging.Severity;
...
public class PeerConnectionFactory {
  ...
  public static class InitializationOptions {
    ...
    public static class Builder {
      ...
      private NativeLibraryLoader nativeLibraryLoader = new org.webrtc.zzwtec.NativeLibrary.DefaultLoader();
      private String nativeLibraryName = "jingle_peerconnection_zzwtec";
  ...
  public static class Builder {
    ...
    public org.webrtc.zzwtec.PeerConnectionFactory createPeerConnectionFactory() {
  ...
  public static void initialize(InitializationOptions options) {
    ...
    org.webrtc.zzwtec.NativeLibrary.initialize(options.nativeLibraryLoader, options.nativeLibraryName);
    ...
    if (options.loggable != null) {
      ...
      nativeInjectLoggable(new org.webrtc.zzwtec.JNILogging(options.loggable), options.loggableSeverity.ordinal());
    } else {
      Logging.d(TAG,
  ...
  private static void checkInitializeHasBeenCalled() {
    if (!org.webrtc.zzwtec.NativeLibrary.isLoaded() || ContextUtils.getApplicationContext() == null) {
  ...
  public static String fieldTrialsFindFullName(String name) {
    return org.webrtc.zzwtec.NativeLibrary.isLoaded() ? nativeFindFieldTrialsFullName(name) : "";
  }
  ...
  private static native org.webrtc.zzwtec.PeerConnectionFactory nativeCreatePeerConnectionFactory(Context context,
  ...
  private static native void nativeInjectLoggable(org.webrtc.zzwtec.JNILogging jniLogging, int severity);
