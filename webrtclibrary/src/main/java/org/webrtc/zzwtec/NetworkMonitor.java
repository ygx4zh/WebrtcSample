...
import static org.webrtc.zzwtec.NetworkMonitorAutoDetect.INVALID_NET_ID;
...
public class NetworkMonitor {
  ...
  private static class InstanceHolder {
    ...
    static final org.webrtc.zzwtec.NetworkMonitor instance = new org.webrtc.zzwtec.NetworkMonitor();
  }
  ...
  @CalledByNative
  public static org.webrtc.zzwtec.NetworkMonitor getInstance() {
  ...
  static NetworkMonitorAutoDetect createAndSetAutoDetectForTest(Context context) {
    org.webrtc.zzwtec.NetworkMonitor networkMonitor = getInstance();
