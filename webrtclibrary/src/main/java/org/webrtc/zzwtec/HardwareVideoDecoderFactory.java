...
public class HardwareVideoDecoderFactory extends org.webrtc.zzwtec.MediaCodecVideoDecoderFactory {
  private final static Predicate<MediaCodecInfo> defaultAllowedPredicate =
      new Predicate<MediaCodecInfo>() {
        private String[] prefixBlacklist =
            Arrays.copyOf(org.webrtc.zzwtec.MediaCodecUtils.SOFTWARE_IMPLEMENTATION_PREFIXES,
                org.webrtc.zzwtec.MediaCodecUtils.SOFTWARE_IMPLEMENTATION_PREFIXES.length);
        @Override
