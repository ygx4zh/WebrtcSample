...
class Camera1Session implements org.webrtc.zzwtec.CameraSession {
  private static final String TAG = "Camera1Session";
  private static final int NUMBER_OF_CAPTURE_BUFFERS = 3;

  private static final org.webrtc.zzwtec.Histogram camera1StartTimeMsHistogram =
      org.webrtc.zzwtec.Histogram.createCounts("WebRTC.Android.Camera1.StartTimeMs", 1, 10000, 50);
  private static final org.webrtc.zzwtec.Histogram camera1StopTimeMsHistogram =
      org.webrtc.zzwtec.Histogram.createCounts("WebRTC.Android.Camera1.StopTimeMs", 1, 10000, 50);
  private static final org.webrtc.zzwtec.Histogram camera1ResolutionHistogram = org.webrtc.zzwtec.Histogram.createEnumeration(
  ...
  public static void create(final CreateSessionCallback callback, final Events events,
    ...
    callback.onDone(new org.webrtc.zzwtec.Camera1Session(events, captureToTexture, applicationContext,
    ...
    camera.setErrorCallback(new android.hardware.Camera.ErrorCallback() {
      ...
      public void onError(int error, android.hardware.Camera camera) {
        ...
        if (error == android.hardware.Camera.CAMERA_ERROR_EVICTED) {
          events.onCameraDisconnected(org.webrtc.zzwtec.Camera1Session.this);
        } else {
          events.onCameraError(org.webrtc.zzwtec.Camera1Session.this, errorMessage);
        }
      }
    });
  ...
  private void listenForTextureFrames() {
    surfaceTextureHelper.startListening((VideoFrame frame) -> {
      ...
      final VideoFrame modifiedFrame = new VideoFrame(
          org.webrtc.zzwtec.CameraSession.createTextureBufferWithModifiedTransformMatrix(
              (TextureBufferImpl) frame.getBuffer(),
              /* mirror= */ info.facing == android.hardware.Camera.CameraInfo.CAMERA_FACING_FRONT,
              /* rotation= */ 0),
          /* rotation= */ getFrameOrientation(), frame.getTimestampNs());
      events.onFrameCaptured(org.webrtc.zzwtec.Camera1Session.this, modifiedFrame);
  ...
  private void listenForBytebufferFrames() {
    camera.setPreviewCallbackWithBuffer(new android.hardware.Camera.PreviewCallback() {
      ...
      public void onPreviewFrame(final byte[] data, android.hardware.Camera callbackCamera) {
        ...
        events.onFrameCaptured(org.webrtc.zzwtec.Camera1Session.this, frame);
        frame.release();
      }
    });
  }
  ...
  private int getFrameOrientation() {
    int rotation = org.webrtc.zzwtec.CameraSession.getDeviceOrientation(applicationContext);
